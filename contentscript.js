chrome.extension.onRequest.addListener(function(request, sender, sendResponse) {
  ...
  if (request.method === 'searchResults') {
    ...
    html += '<article id="spotify-results"><div><img class="logo" src="https://d2c87l0yth4zbw.cloudfront.net/i/_global/logo.png" /><p>{total} results for "{selectedText}"</p><a href="https://www.spotify.com" target="_blank">Get Spotify</a></div>'
    ...
    if (results.length > 0) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        html += '<li><a href="{href}" title="{title}"><img src="{imageUrl}" /><span>{title}</span></a></li>'
